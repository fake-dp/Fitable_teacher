  ...
  return (
    <MainContainer>
      <MyProfileHeaderGrid
        name={name}
        phone={phone}
        onPress={goMyAccountScreen}
      />

      <GridLine />

      <MySettingListBtnGrid onPress={goMyCenterSettingScreen}>
        연동센터 설정
      </MySettingListBtnGrid>
      <MySettingListBtnGrid onPress={goMyProfileScreen}>
        프로필 관리
      </MySettingListBtnGrid>

      <GridLine />

      <MySettingListBtnGrid text="toggle" isOnPushAlarm={isOnPushAlarm}>
        알림
      </MySettingListBtnGrid>
      <MySettingListBtnGrid onPress={goMyTermsScreen}>
        이용약관 및 정책
      </MySettingListBtnGrid>
