...
export const getMemberConditions = async id => {
  try {
    const response = await customAxios.get(
      `/api/trainers/v1/tickets/${id}/conditions`,
    );
    return response.data;
  } catch (error) {
    throw error.response.data;
...
export const getBookmarkTickets = async id => {
  try {
    const response = await customAxios.get(
      `/api/trainers/v1/centers/${id}/tickets/bookmark`,
    );
    return response.data;
  } catch (error) {
    throw error.response.data;
...
export const getMemberDetail = async ({id, memberId}) => {
  try {
    const response = await customAxios.get(
      `/api/trainers/v1/centers/${id}/members/${memberId}`,
    );
...
export const getMemberCoupons = async ({id, memberId}) => {
  try {
    const response = await customAxios.get(
      `/api/trainers/v1/centers/${id}/members/${memberId}/coupons`,
    );
    return response.data;
  } catch (error) {
    throw error.response.data;
...
//     }
// }
export const getMemberManage = async ({
  centerId,
  type,
  searchTerm,
  member,
  ...
  try {
    const response = await customAxios.get(
      `/api/trainers/v1/centers/${centerId}/members/type/${type}?page=0&size=3000`,
      {
        params: {
...
export const getMemberContractList = async id => {
  try {
    const response = await customAxios.get(
      `/api/trainers/v1/centers/${id}/contracts`,
    );
    return response.data;
  } catch (error) {
    throw error.response.data;
...
export const getMemberContractTicketList = async ({centerId, memberId}) => {
  try {
    const response = await customAxios.get(
      `/api/trainers/v1/centers/${centerId}/members/${memberId}/contracts/tickets`,
    );
    return response.data;
  } catch (error) {
    throw error.response.data;
